...
func (UnimplementedPokerServiceServer) GetLastWinners(context.Context, *GetLastWinnersRequest) (*GetLastWinnersResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLastWinners not implemented")
}
...
const (
	...
	LobbyService_WatchTable_FullMethodName              = "/poker.LobbyService/WatchTable"
	LobbyService_LeaveTable_FullMethodName              = "/poker.LobbyService/LeaveTable"
	LobbyService_UnwatchTable_FullMethodName            = "/poker.LobbyService/UnwatchTable"
...
type LobbyServiceClient interface {
	...
	WatchTable(ctx context.Context, in *WatchTableRequest, opts ...grpc.CallOption) (*WatchTableResponse, error)
	LeaveTable(ctx context.Context, in *LeaveTableRequest, opts ...grpc.CallOption) (*LeaveTableResponse, error)
	UnwatchTable(ctx context.Context, in *UnwatchTableRequest, opts ...grpc.CallOption) (*UnwatchTableResponse, error)
...
func (c *lobbyServiceClient) WatchTable(ctx context.Context, in *WatchTableRequest, opts ...grpc.CallOption) (*WatchTableResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WatchTableResponse)
	err := c.cc.Invoke(ctx, LobbyService_WatchTable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lobbyServiceClient) UnwatchTable(ctx context.Context, in *UnwatchTableRequest, opts ...grpc.CallOption) (*UnwatchTableResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UnwatchTableResponse)
	err := c.cc.Invoke(ctx, LobbyService_UnwatchTable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LobbyServiceServer interface {
	...
	WatchTable(context.Context, *WatchTableRequest) (*WatchTableResponse, error)
	LeaveTable(context.Context, *LeaveTableRequest) (*LeaveTableResponse, error)
	UnwatchTable(context.Context, *UnwatchTableRequest) (*UnwatchTableResponse, error)
...
func (UnimplementedLobbyServiceServer) WatchTable(context.Context, *WatchTableRequest) (*WatchTableResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method WatchTable not implemented")
}
...
func (UnimplementedLobbyServiceServer) UnwatchTable(context.Context, *UnwatchTableRequest) (*UnwatchTableResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UnwatchTable not implemented")
}
...
func (UnimplementedLobbyServiceServer) GetPlayerCurrentTable(context.Context, *GetPlayerCurrentTableRequest) (*GetPlayerCurrentTableResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPlayerCurrentTable not implemented")
}
func (UnimplementedLobbyServiceServer) SetPlayerReady(context.Context, *SetPlayerReadyRequest) (*SetPlayerReadyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetPlayerReady not implemented")
}
func (UnimplementedLobbyServiceServer) SetPlayerUnready(context.Context, *SetPlayerUnreadyRequest) (*SetPlayerUnreadyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetPlayerUnready not implemented")
}
func (UnimplementedLobbyServiceServer) StartNotificationStream(*StartNotificationStreamRequest, grpc.ServerStreamingServer[Notification]) error {
	return status.Error(codes.Unimplemented, "method StartNotificationStream not implemented")
}
...
func _LobbyService_WatchTable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WatchTableRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LobbyServiceServer).WatchTable(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LobbyService_WatchTable_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LobbyServiceServer).WatchTable(ctx, req.(*WatchTableRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _LobbyService_UnwatchTable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnwatchTableRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LobbyServiceServer).UnwatchTable(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LobbyService_UnwatchTable_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LobbyServiceServer).UnwatchTable(ctx, req.(*UnwatchTableRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LobbyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WatchTable",
			Handler:    _LobbyService_WatchTable_Handler,
		},
		{
		...
		{
			MethodName: "UnwatchTable",
			Handler:    _LobbyService_UnwatchTable_Handler,
		},
		{
...
const (
	...
	AuthService_GetUserInfo_FullMethodName      = "/poker.AuthService/GetUserInfo"
)
